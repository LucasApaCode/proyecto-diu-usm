      ...
      <div className="overflow-x-auto">
        <table className="table-auto border text-[20px] mx-auto whitespace-nowrap">
          <thead className="bg-gray-100">
            <tr>
              <th className="border px-1 py-1 text-gray-800">Ubicación</th>
              <th className="border px-1 py-1 text-gray-800">Biblioteca</th>
              {diasSemana.map((dia) => (
                <th key={dia} className="border px-1 py-1 text-gray-800">{dia}</th>
              ))}
            </tr>
          </thead>
          <tbody>{filas}</tbody>
...
export default HorarioBiblioteca;